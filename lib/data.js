...
export const personalInfo = {
  ...
  bioParagraphs: [
    "I'm a Full Stack Developer and MSc researcher at RUET, Bangladesh, specializing in building performant, scalable web applications with the MERN stack, Next.js, and modern authentication systems. I care deeply about UI/UX — every interface I build is intentional, accessible, and visually refined.",
    "Beyond development, I'm actively exploring AI engineering — working with LangChain.js, RAG pipelines, and the Vercel AI SDK to integrate intelligent features into real-world products. My MSc research focuses on NLP and Bangla language processing with transformer models, sitting at the intersection of software engineering and applied AI.",
  ],
